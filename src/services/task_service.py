...
class TaskService:
    ...
    def get_user_tasks(
        ...
        if filters:
            return self.task_repo.get_all_by_user(
                user_id=user_id,
                skip=skip,
                limit=limit,
            ...
            return self.task_repo.get_all_by_user(user_id, skip, limit)
    ...
    def get_tasks_by_status(
        ...
        return self.task_repo.get_by_status(user_id, status, skip, limit)
    ...
    def get_tasks_by_category(
        ...
        return self.task_repo.get_by_category(user_id, category_id, skip, limit)
    ...
    def get_overdue_tasks(
        ...
        return self.task_repo.get_overdue_tasks(user_id, skip, limit)
    ...
    def search_tasks(
        ...
        return self.task_repo.search_tasks(query, user_id, skip, limit)
    ...
    def update_task(self, task_id: int, task_data: TaskUpdate, user_id: int) -> Task:
        ...
        if task_data.description is not None:
            update_data["description"] = task_data.description.strip() if task_data.description else None
        ...
        if task_data.category_id is not None:
            update_data["category_id"] = task_data.category_id if task_data.category_id > 0 else None
    ...
    def update_task_status(self, task_id: int, new_status: StatusEnum, user_id: int) -> Task:
    ...
    def bulk_update_status(self, task_ids: List[int], new_status: StatusEnum, user_id: int) -> List[Task]:
